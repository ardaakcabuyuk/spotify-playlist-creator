...
# from spotipy.oauth2 import SpotifyOAuth
# # #
# scope = 'ugc-image-upload playlist-modify-public playlist-modify-private user-library-modify'
# # #
# # set open_browser=False to prevent Spotipy from attempting to open the default browser
# sp = spotipy.Spotify(auth_manager=SpotifyOAuth(scope=scope))
# # sp = spotipy.Spotify(auth_manager=SpotifyOAuth(open_browser=False))
...
# # print("\"", playlist_name, "\" is created")
#
# a = sp.user_playlists('hpa6zlnetl6hib5bnp1b5laul')
# # print(a)
...
# # sp.playlist_upload_cover_image('spotify:playlist:7bodE6U6FML6XzOF8yEFRT', encoded_string)
...
def playlist_creator(x_train2, y_train2, recorded_indices2, song_info2, spr, playlist_id):
    ...
    for k in recomended_song_indexes[:3]:
        ...
        print(tracks)
        spr.playlist_add_items(playlist_id=playlist_id, items=tracks, position=None)
    return
...
playlist_recs = sp.user_playlist_create(username, name='CS464 - Playlist')
...
sourcePlaylistID = '1PG2H9rT3rm0N6ViLWlioI'
